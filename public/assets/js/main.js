(function() {
	...
	ScheduleTemplate.prototype.loadEventContent = function(content) {
		console.log("sdfhgsdhfghsdhf");
		// load the content of an event when user selects it
		var self = this;
      	self.modal.getElementsByClassName('cd-schedule-modal__event-info')[0].innerHTML = self.getEventContent('dfghdfhdfgh'); 
