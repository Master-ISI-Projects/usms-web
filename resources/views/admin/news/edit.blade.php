                ...
                <div class="col-md-3">
                    <div class="card mb-4">
                        <div class="card-body text-center">
                            ...
                            <img id="user-picture" style="width: 100%; height: 200px;" src="{{ $news->image_path }}" >
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{ old('title', $news->title) }}" placeholder="Titre">
                                @error('title')
                            ...
                            <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="scholar_year_id" class="form-control @error('scholar_year_id') is-invalid @enderror" id="scholar_year_id">
                                            @foreach ($scholarYears as $scholarYear)
                                                <option {{ old('scholar_year_id', $news->scholar_year_id) == $scholarYear->id ? 'selected' : '' }} value="{{ $scholarYear->id }}">{{ $scholarYear->scholar_year }}</option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker @error('published_at') is-invalid @enderror" name="published_at" readonly autocomplete="off" id="published_at" value="{{ Helper::formatDate(old('published_at', $news->published_at)) }}" placeholder="Date de publication">
                                        @error('published_at')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" cols="30" rows="10" placeholder="Contenu">{{ old('description', $news->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
