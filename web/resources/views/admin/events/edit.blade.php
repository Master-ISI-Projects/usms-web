...
@section('title', 'Evénement: ' . $event->title)
            ...
            <div class="col-12">
                ...
                <nav class="breadcrumb-container d-none d-sm-block d-lg-inline-block" aria-label="breadcrumb">
                    <ol class="breadcrumb pt-0">
                        ...
                        <li class="breadcrumb-item">
                            <a href="{{ route('events.index') }}">Evénements</a>
                        </li>
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('title') is-invalid @enderror" name="title" id="title" value="{{ old('title', $event->title) }}" placeholder="Titre">
                                @error('title')
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control datepicker @error('start_at') is-invalid @enderror" name="start_at" readonly autocomplete="off" id="start_at" value="{{ Helper::formatDate(old('start_at', $event->start_at)) }}" placeholder="Date d'événement">
                                        @error('start_at')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control @error('duration') is-invalid @enderror" name="duration"id="duration" value="{{ old('duration', $event->duration) }}" placeholder="Durée">
                                        @error('duration')
                                            <span class="invalid-feedback" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select name="scholar_year_id" class="form-control @error('scholar_year_id') is-invalid @enderror" id="scholar_year_id">
                                            @foreach ($scholarYears as $scholarYear)
                                                <option {{ old('scholar_year_id', $event->scholar_year_id) == $scholarYear->id ? 'selected' : '' }} value="{{ $scholarYear->id }}">{{ $scholarYear->scholar_year }}</option>
                                            @endforeach
                                        </select>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" cols="30" rows="10" placeholder="Description">{{ old('description', $event->description) }}</textarea>
                                @error('description')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
